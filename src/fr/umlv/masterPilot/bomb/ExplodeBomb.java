 ...
 */
public class ExplodeBomb implements Bomb {


    private final int maskBit;
    private final int category;
    private final Bomb.BombType bombType = BombType.MEGABOMB;
    /**
    ...
    public ExplodeBomb(World world, float x_axis, float y_axis) {
        this.world = world;
        this.x_axis = x_axis;
        this.y_axis = y_axis;
    ...
    public ExplodeBomb(World world, float x_axis, float y_axis, boolean flag) {
        this.world = world;
        this.x_axis = x_axis;
        this.y_axis = y_axis;
    ...
    public void create() {
        ...
        if (flag) {
            fd.userData = Color.ORANGE;
        } else {
            fd.userData = Color.lightGray;
        }
